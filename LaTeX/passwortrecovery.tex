...
Wurde das \emph{Logindaten vergessen}-Formular ausgefüllt, so erhält der Nutzer eine E-Mail mit den neu generierten Zugangsdaten. Bei dieser E-Mail fällt sofort auf, dass die gesamte Anrede fehlt. Die E-Mail beginnt, ohne jegliches Grußwort, mit \emph{Ihre Zugangsdaten lauten wie folgt:} .
}{
